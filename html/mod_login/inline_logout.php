...
?>
<div class="inline-menu mod_login_inline">
  <form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form">
      ...
      <li class="list-inline-item">
        <button type="submit" name="Submit" class="" href="<?php echo JRoute::_('index.php?option=com_users&view=login'); ?>" title="Logout">Esci</button>
      </li>
    </ul>
