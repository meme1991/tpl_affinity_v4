...
?>
<?php if (count($list)) : ?>
	<div class="tagscloud w-100 <?php echo $moduleclass_sfx; ?>">
		<?php
		...
		?>
		<a href="<?php echo JRoute::_(TagsHelperRoute::getTagRoute($item->tag_id . '-' . $item->alias)); ?>" style="font-size: <?php echo $fontsize . 'em'; ?>" class="btn btn-outline-primary btn-sm tags m-1">
